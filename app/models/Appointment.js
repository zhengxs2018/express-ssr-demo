...
schema.plugin(fieldEncryption,
  {
    fields: ['eventId', 'providerId', 'patientId', 'meetingId', 'meetingPassword', 'createdAt',
      'updatedAt', 'startTime', 'endTime', 'description', 'patientPaid', 'status',
      'hostJoined', 'followUp', 'returnDocuments'],
